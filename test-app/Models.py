...
class Answer(Base):
    ...
    question_id = Column(Integer, ForeignKey(
        "question.question_id", ondelete="CASCADE"))
    question = relationship(
        'Question', backref=backref('answers', uselist=True))
...
class Test(Base):
    ...
    def __repr__(self) -> str:
        return f"Test object: Test id: {self.test_id}. Test text: {self.test_test}"


if __name__ == "__main__":
    engine = create_engine(
        'sqlite:///C:\\Users\\USER\\Desktop\\programacion\\lp-1\\test-app\\testsdb\\test.db', echo=True)
