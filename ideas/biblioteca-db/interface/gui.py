...
class LibraryGUI:
    ...
    def create_widgets(self):
        ...
        self.eliminar_prestamo_button = tk.Button(
            self.root,
            text="Eliminar Prestamo", command=self.eliminar_prestamo)
    ...
    def submit_prestamo(self):
        fecha_prestamo = self.title_entry.get()
        fecha_devolucion = self.author_entry.get()
        libro_id = self.genre_entry.get()
        if fecha_prestamo and fecha_devolucion and libro_id:
            self.db_manager.add_prestamo(
                fecha_prestamo, fecha_devolucion, libro_id)
            messagebox.showinfo("Éxito", "Prestamo añadido correctamente")
            self.new_window.destroy()
        else:
            messagebox.showwarning(
                "Error", "Todos los campos son obligatorios")
    ...
    def prestamo(self):
        ...
        self.title_label = tk.Label(self.new_window, text="Fecha de Prestamo")
        self.title_label.pack()
        self.title_entry = tk.Entry(self.new_window)
        self.title_entry.pack()
        self.dev_label = tk.Label(self.new_window, text="Fecha de Devolucion")
        self.author_label.pack()
